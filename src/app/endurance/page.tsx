    ...
    <main className="max-w-4xl mx-auto min-h-screen p-4 md:p-8 relative z-10">
      ...
      <section className="space-y-4">
        ...
        <div className="relative border-l-2 border-slate-800 ml-3 pl-8 py-2 space-y-8">
          {[
            { title: "Bike", model: "Oggi Velloce 2024", desc: "Shimano Claris R2000 (16v), Garfo Carbono, Disc Brakes" },
            { title: "Indoor", model: "Absolute Wild 2", desc: "Rolo de Treinamento Magnético (Fixo)" },
